...
public class winlvl0 : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        if (File.Exists(Application.persistentDataPath + "/player.Playscore0"))
        {
            lvl1Data data = Savelvl0.LoadData();
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        if (collision.collider.tag == "Player")
        {
            ...
            if(Highscore > mayHighscore)
            {
                ...
                highscoretext.text = "you broke your Highscore by" + (mayHighscore - Highscore) + "sec";
            }
